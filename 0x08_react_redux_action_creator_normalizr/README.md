...
- [Normalizr](https://intranet.hbtn.io/rltoken/Wcn6pQRMJtPeYKA9tSYZaw)
- [Normalizing State Shape](https://intranet.hbtn.io/rltoken/olK9C_5w1YVjoEYX14enjw)
...
- [Async Actions](https://intranet.hbtn.io/rltoken/jGY3MvS-OcYkhCJll4EI8g)
- [Writing tests for Redux](https://intranet.hbtn.io/rltoken/Sv_kLEaJEot36wuYUg2uDw)
### Learning Objectives
At the end of this project, you are expected to be able to [explain to anyone](https://intranet.hbtn.io/rltoken/YWniKf3iaJwqGkGNcBBZWg), without the help of Google:
